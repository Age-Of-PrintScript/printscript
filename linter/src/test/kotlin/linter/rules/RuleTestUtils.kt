...
fun createPrintln(vararg args: Expression): AST.Call = AST.Call(
    functionName = PrintScriptFunctions.PRINTLN,
    args = args.toList()
)

fun createLiteralExpression(value: Number): Expression.Literal =
    Expression.Literal(PrintScriptValue.NumberLiteral(value))

fun createLiteralExpression(value: String): Expression.Literal =
    Expression.Literal(PrintScriptValue.StringLiteral(value))

fun createVariableExpression(name: String): Expression.Variable =
