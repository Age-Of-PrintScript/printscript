...
internal interface State {
    fun consume(token: Token, builder: ASTBuilder): Either<ParsingError, ConsumeResult>
}

// ---------- Start ----------

internal object Start : State {
    override fun consume(token: Token, builder: ASTBuilder): Either<ParsingError, ConsumeResult> {
